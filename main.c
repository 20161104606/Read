...
//  Read
//
//  Created by qiuyu143 on 2017/6/26.
...
int main(int argc, const char * argv[]) {
    ...
    int Gps;
    fp1=fopen("//Users//qiuyu143//Desktop//Read//gps.txt","w+");
    fp2=fopen("//Users//qiuyu143//Desktop//Read//GPS170510.log","r");
    fp3=fopen("//Users//qiuyu143//Desktop//Read//gps.csv","w+");
    if(fp2==NULL)
    {
